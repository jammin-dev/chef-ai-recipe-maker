...
export class RecipesService {
     ...
     * @throws ApiError
     */
    public static generateRecipe(data: RecipesGenerateRecipeData): CancelablePromise<RecipesGenerateRecipeResponse> {
        return __request(OpenAPI, {
            method: 'POST',
